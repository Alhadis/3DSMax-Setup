...
(
	...
	if sceneMaxLights.count > 0 then SortNodeArrayByNameAscendingOrder sceneMaxLights
	if sceneLSLights.count > 0 then SortNodeArrayByNameAscendingOrder sceneLSLights
	if sceneSkyLights.count > 0 then SortNodeArrayByNameAscendingOrder sceneSkyLights
	if sceneSunLights.count > 0 then SortNodeArrayByNameAscendingOrder sceneSunLights
	if sceneLuminaires.count > 0 then SortNodeArrayByNameAscendingOrder sceneLuminaires
	if scenemiLights.count > 0 then SortNodeArrayByNameAscendingOrder scenemiLights
	if scenemrSkyLights.count > 0 then SortNodeArrayByNameAscendingOrder scenemrSkyLights
	if scenemrSunLights.count > 0 then SortNodeArrayByNameAscendingOrder scenemrSunLights
	if scenemrSkyPortalLights.count > 0 then SortNodeArrayByNameAscendingOrder scenemrSkyPortalLights
	if sceneVRayLights.count > 0 then SortNodeArrayByNameAscendingOrder sceneVRayLights
	if sceneVRayIESLights.count > 0 then SortNodeArrayByNameAscendingOrder sceneVRayIESLights
	if sceneVRayAmbientLights.count > 0 then SortNodeArrayByNameAscendingOrder sceneVRayAmbientLights
	if sceneVRaySunSkyLights.count > 0 then SortNodeArrayByNameAscendingOrder sceneVRaySunSkyLights
	...
	local titleTemplates = titleTemplate \
		...
		vrayIESLights:#(td "On" 8, td "Name" 28, td "Power" 147, td "Color" 205, td "Temperature" 233, td "Shadows" 307, td "Subdivs" 353, td "Bias" 411, td "Diff." 473, td "Spec." 497, td "Use shape" 527, td "Area spec." 581, td "Caust. subd." 635, td "Wire Color" 699, td "Text" 757) \
		vrayAmbientLights:#(td "On" 8, td "Name" 28, td "Intensity" 147, td "Color" 205, td "Caust. subd." 233, td "Wire Color" 299) \
		vraySunSkyLights:#(td "On" 8, td "Name" 28, td "Intens. Mult." 145, td "Size Mult." 211, td "Sh. Subdivs" 263, td "Sh. Bias" 325, td "Invisible" 377, td "Turbidity" 419, td "Ozone" 477, td "Ph. Emit Rad." 535, td "Sky Model "605, td "Horiz. Illum." 697, td "Caust. subd." 757) \
		maxLights:#(td "On" 8, td "Name" 28, td "Multiplier" 147, td "Color" 205, td "Shadows" 235, td "Map Size" 377, td "Bias" 435, td "Sm.Range" 488, td "Transp." 540, td "Int." 580, td "Qual." 615, td "Decay" 657, td "Start" 735, td "Caust. subd." 795) \
		lsLights:#(td "On" 8, td "Name" 28, td "Intensity(cd)" 147, td "Color" 205, td "Shadows" 235, td "Map Size" 377, td "Bias" 435, td "Sm.Range" 488, td "Transp." 540, td "Int." 580, td "Qual." 615, td "Length" 657, td "Width/Radius" 716) \
		miLights:#(td "On" 8, td "Name" 28, td "Multiplier" 147, td "Color" 205, td "Shadows" 235, td "Map Size" 377, td "Bias" 435, td "Sm.Range" 488, td "Transp." 540, td "Int." 580, td "Qual." 615, td "Decay" 657, td "Start" 735) \
		luminaires:#(td "Name" 28, td "Dimmer" 147, td "Color" 205) \
		sunLights:#(td "On" 8, td "Name" 28, td "Intensity(lux)" 147, td "Color" 205, td "Shadows" 235, td "Map Size" 377, td "Bias" 435, td "Sm.Range" 488, td "Transp." 540, td "Int." 580, td "Qual." 615) \
		skyLights:#(td "On" 8, td "Name" 28, td "Multiplier" 147, td "Color" 205) \
		mrSkyLights:#(td "On" 8, td "Name" 28, td "Multiplier" 147, td "Haze" 206, td "H Height" 263, td "H Blur" 322, td "Ground" 378, td "Night" 427, td "Redness" 465, td "Saturation" 525, td "UseAerialPersp" 585, td "AerialPersp" 665) \
		mrSunLights:#(td "On" 8, td "Name" 28, td "Multiplier" 147, td "Shadows" 204, td "Softness" 256, td "Samples" 303, td "Targeted" 349, td "Distance" 398, td "Inherit" 471, td "Haze" 508, td "H Height" 558, td "Redness" 606, td "Saturation" 654, td "Use Targ" 708, td "Radius" 757) \
		mrSkyPortalLights:#(td "On" 8, td "Name" 28, td "Multiplier" 147, td "Color" 205, td "Shadows" 235, td "Extend" 285, td "Samples" 325, td "Length" 380, td "Width" 453, td "Flip Flux" 523, td "Visible" 570, td "Transparency" 605, td "Source" 685)
		-- End Localization
	...
	fn CreateControls hasMultiplier:false hasColor:false hasShadow:false hasDecay:false hasSize:false hasWireColor:false hasIconText:false isLuminaire:false isMRSky:false isMRSun:false isMRSkyPortal:false isVRayLight:false isVRayIESLight:false isVRayAmbientLight:false isVRaySun:false hasCausticsSubdivs:false =
	(
		...
		(
			...
			vrayLLister.maxLightsRC.addControl #edittext (("LightName" + vrayLLister.count as string) as name) "" \
				paramStr:(" text:" + wrappedName + " width:120 height:16 offset:[23,"+ (-21+ vrayLLister.yOffset) as string + "] height:21")
		...
		(
			...
			vrayLLister.maxLightsRC.addControl #dropDownList (("LightName" + vrayLLister.count as string) as name) "" filter:on\
				paramStr:(" items:" + NameList + " width:120 offset:[27,"+ (-22+ vrayLLister.yOffset) as string + "] ")
		)
		...
		if hasMultiplier do (
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightMult" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[145," + (isUsingEdittextOffset-24+vrayLLister.yOffset) as string + "] enabled:" + multiplierEn as string)
		...
		if hasColor do (
			...
			vrayLLister.maxLightsRC.addControl #colorpicker (("LightCol" + vrayLLister.count as string) as name) "" \
				...
				" offset:[203,"+ (-23+ vrayLLister.yOffset) as string + "] width:25 enabled:" + colorEn as string)
		...
		if hasShadow do (
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("LightShdOn" + vrayLLister.count as string) as name) "" \
				...
				" offset:[235,"+ (-22+ vrayLLister.yOffset) as string + "] width:15")
			...
			vrayLLister.maxLightsRC.addControl #dropDownList (("LightShd" + vrayLLister.count as string) as name) "" filter:on\
				paramStr:(" items:" + vrayLLister.ShadowPluginsName as string + " width:110 offset:[255,"+ (-24+ vrayLLister.yOffset) as string + "]" + \
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightMapSiz" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[375,"+ (-24+ vrayLLister.yOffset) as string + "] enabled:" \
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightBias" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[433,"+ (-21+ vrayLLister.yOffset) as string + "] enabled:" \
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightSmpRange" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[491,"+ (-21+ vrayLLister.yOffset) as string + "] enabled:" + (LLShadowClass == shadowMap or LLShadowClass == mental_ray_shadow_map) as string)
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("LightTrans" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + \
						...
						" offset:[553,"+ (-20+ vrayLLister.yOffset) as string + "] width:15 enabled:" + \
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightInteg" + vrayLLister.count as string) as name) "" \
				paramStr:("type:#integer fieldwidth:30 align:#left range:[1,15," + \
						...
						"] offset:[566,"+ (-21+ vrayLLister.yOffset) as string + "] width:15 enabled:" + \
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightQual" + vrayLLister.count as string) as name) "" \
				paramStr:("type:#integer fieldwidth:30 align:#left range:[1,15," + \
						...
						"] offset:[610,"+ (-21+ vrayLLister.yOffset) as string + "] width:15 enabled:" + \
						((LLShadowClass == Area_Shadows or LLShadowClass == Blur_Adv__Ray_Traced or \
						LLShadowClass == Adv__Ray_Traced) as string))
		...
		(
			...
			vrayLLister.maxLightsRC.addControl #dropDownList (("LightDecay" + vrayLLister.count as string) as name) "" filter:on\
				paramStr:(" items:" + vrayLLister.decayStrings as string + " width:80 offset:[657,"+ (-24+ vrayLLister.yOffset) as string + "]" + \
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightDecStart" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[735,"+ (-24+ vrayLLister.yOffset) as string + "]")
		...
		(
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LSLightLength" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[655,"+ (-21+ vrayLLister.yOffset) as string + "] enabled:" \
				+ (hasLength as string))
			...
			if (hasWidth) then (
				vrayLLister.maxLightsRC.addControl #spinner (("LSLightWidth" + vrayLLister.count as string) as name) "" \
					...
					"fieldwidth:45 align:#left offset:[714,"+ (-21+ vrayLLister.yOffset) as string + "] enabled:" \
					+ (hasWidth as string))
		...
		-- Viewport wire color
		if hasWireColor do (
			local wireColorX=case lightClassName of (
				#VRayLight:         827
				#VRayIES:           703
				#VRayAmbientLight:  301
				default:            827
			)

			-- Wire color
			local wireColorOnTmp = (vrayLLister.LightIndex[vrayLLister.count][1].viewport_wire_color_on)
			vrayLLister.maxLightsRC.addControl #checkbox (("WireColorOn" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + wireColorOnTmp as string + " offset:[" + wireColorX as string + ","+ (-23+ vrayLLister.yOffset) as string + "] width:15")
			vrayLLister.maxLightsRC.addHandler (("WireColorOn" + vrayLLister.count as string) as name) #'changed state' filter:on \
				codeStr:("vrayLLister.setLightProp vrayLLister.LightIndex[" + vrayLLister.count as string + "][1].baseobject #viewport_wire_color_on state")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("WireColorOn" + vrayLLister.count as string) as name)
			
			wireColorX+=15
			local wireColorTmp = (vrayLLister.LightIndex[vrayLLister.count][1].viewport_wire_color)
			vrayLLister.maxLightsRC.addControl #colorpicker (("WireColor" + vrayLLister.count as string) as name) "" \
				paramStr:("color:" + wireColorTmp as string + " offset:[" + wireColorX as string + ","+ (-23+ vrayLLister.yOffset) as string + "] width:25")
			vrayLLister.maxLightsRC.addHandler (("WireColor" + vrayLLister.count as string) as name) #'changed val' filter:on \
				codeStr:("vrayLLister.setLightProp vrayLLister.LightIndex[" + vrayLLister.count as string + "][1].baseobject #viewport_wire_color val")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("WireColor" + vrayLLister.count as string) as name)
		) -- end hasWireColor

		if hasIconText do (
			local hasTextX=case lightClassName of (
				#VRayLight: 885
				#VRayIES: 761
				default: 885
			)
			local iconTextOnTmp = (vrayLLister.LightIndex[vrayLLister.count][1].icon_text)
			vrayLLister.maxLightsRC.addControl #checkbox (("IconTextOn" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + iconTextOnTmp as string + " offset:[" + hasTextX as string + ","+ (-23+ vrayLLister.yOffset) as string + "] width:15")
			vrayLLister.maxLightsRC.addHandler (("IconTextOn" + vrayLLister.count as string) as name) #'changed state' filter:on \
				codeStr:("vrayLLister.setLightProp vrayLLister.LightIndex[" + vrayLLister.count as string + "][1].baseobject #icon_text state")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("IconTextOn" + vrayLLister.count as string) as name)
		) -- end hasIconText
		...
		(
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightHaze" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[203,"+ (-21+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightHHeight" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[261,"+ (-21+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightHBlur" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[319,"+ (-21+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #colorpicker (("LightGroundCol" + vrayLLister.count as string) as name) "" \
				...
				" offset:[380,"+ (-23+ vrayLLister.yOffset) as string + "] width:25")
			...
			vrayLLister.maxLightsRC.addControl #colorpicker (("LightNightCol" + vrayLLister.count as string) as name) "" \
				...
				" offset:[425,"+ (-25+ vrayLLister.yOffset) as string + "] width:25")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightRedness" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[464,"+ (-23+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightSaturation" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[522,"+ (-21+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("LightUseAerPersp" + vrayLLister.count as string) as name) "" \
				...
				" offset:[615,"+ (-21+ vrayLLister.yOffset) as string + "] width:15")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightAerialPersp" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:60 align:#left offset:[663,"+ (-21+ vrayLLister.yOffset) as string + "]")
		...
		(
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("LightShdOn" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + (vrayLLister.getLightProp vrayLLister.LightIndex[vrayLLister.count][1].baseObject #castshadows as string)+ \
				" offset:[220,"+ (-22+ vrayLLister.yOffset) as string + "] width:15")
			vrayLLister.maxLightsRC.addHandler (("LightShdOn" + vrayLLister.count as string) as name) #'changed state' filter:on \
				codeStr:("vrayLLister.setLightProp vrayLLister.LightIndex[" + vrayLLister.count as string + "][1].baseobject #castshadows state")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("LightShdOn" + vrayLLister.count as string) as name)
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightShdSoft" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:35 align:#left offset:[255,"+ (-20+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightShdSamples" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:35 align:#left offset:[304,"+ (-20+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("LightHasTarg" + vrayLLister.count as string) as name) "" \
				...
				" offset:[365,"+ (-21+ vrayLLister.yOffset) as string + "] width:15")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightTargDist" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:60 align:#left offset:[397,"+ (-20+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("LightInherit" + vrayLLister.count as string) as name) "" \
				...
				" offset:[480,"+ (-21+ vrayLLister.yOffset) as string + "] width:15")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightHaze" + vrayLLister.count as string) as name) "" \
				paramStr:("range:[0,15," + ((vrayLLister.getLightProp vrayLLister.LightIndex[vrayLLister.count][1] #haze) as string) + "] type:#float " + \
				"fieldwidth:35 align:#left offset:[508,"+ (-20+ vrayLLister.yOffset) as string + "]")
			vrayLLister.maxLightsRC.addHandler (("LightHaze" + vrayLLister.count as string) as name) #'changed val' filter:on \
				codeStr:("vrayLLister.setLightProp vrayLLister.LightIndex[" + vrayLLister.count as string + "][1] #haze val")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("LightHaze" + vrayLLister.count as string) as name)
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightHHeight" + vrayLLister.count as string) as name) "" \
				paramStr:("range:[-10,10," + ((vrayLLister.getLightProp vrayLLister.LightIndex[vrayLLister.count][1] #horizonheight) as string) + "] type:#float " + \
				"fieldwidth:35 align:#left offset:[558,"+ (-21+ vrayLLister.yOffset) as string + "]")
			vrayLLister.maxLightsRC.addHandler (("LightHHeight" + vrayLLister.count as string) as name) #'changed val' filter:on \
				codeStr:("vrayLLister.setLightProp vrayLLister.LightIndex[" + vrayLLister.count as string + "][1] #horizonheight val")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("LightHHeight" + vrayLLister.count as string) as name)
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightRedness" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:35 align:#left offset:[608,"+ (-21+ vrayLLister.yOffset) as string + "]")
			vrayLLister.maxLightsRC.addHandler (("LightRedness" + vrayLLister.count as string) as name) #'changed val' filter:on \
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightSaturation" + vrayLLister.count as string) as name) "" \
				paramStr:("range:[0,2," + ((vrayLLister.getLightProp vrayLLister.LightIndex[vrayLLister.count][1] #saturation) as string) + "] type:#float " + \
				"fieldwidth:35 align:#left offset:[658,"+ (-21+ vrayLLister.yOffset) as string + "]")
			vrayLLister.maxLightsRC.addHandler (("LightSaturation" + vrayLLister.count as string) as name) #'changed val' filter:on \
				codeStr:("vrayLLister.setLightProp vrayLLister.LightIndex[" + vrayLLister.count as string + "][1] #saturation val")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("LightSaturation" + vrayLLister.count as string) as name)
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("LightUsePTarg" + vrayLLister.count as string) as name) "" \
				...
				" offset:[723,"+ (-21+ vrayLLister.yOffset) as string + "] width:15")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightPhotonTarg" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:60 align:#left offset:[745,"+ (-21+ vrayLLister.yOffset) as string + "]")
		...
		(
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("LightShdOn" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + (vrayLLister.getLightProp vrayLLister.LightIndex[vrayLLister.count][1].baseObject #castshadows as string)+ \
				" offset:[255,"+ (-22+ vrayLLister.yOffset) as string + "] width:15")
			vrayLLister.maxLightsRC.addHandler (("LightShdOn" + vrayLLister.count as string) as name) #'changed state' filter:on \
				codeStr:("vrayLLister.setLightProp vrayLLister.LightIndex[" + vrayLLister.count as string + "][1].baseobject #castshadows state")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("LightShdOn" + vrayLLister.count as string) as name)
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("LightExtShad" + vrayLLister.count as string) as name) "" \
				...
				" offset:[295,"+ (-21+ vrayLLister.yOffset) as string + "] width:15")
			...
			vrayLLister.maxLightsRC.addControl #dropDownList (("LightShdSamples" + vrayLLister.count as string) as name) "" filter:on\
				paramStr:(" items:" + vrayLLister.MRSkyPortal_ShadowSamples as string + " width:52 offset:[323,"+ (-23+ vrayLLister.yOffset) as string + "]" + \
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightLength" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:60 align:#left offset:[376,"+ (-24+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("LightWidth" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:60 align:#left offset:[451,"+ (-21+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("LightAreaVisible" + vrayLLister.count as string) as name) "" \
				...
				" offset:[580,"+ (-21+ vrayLLister.yOffset) as string + "] width:15")
			...
			vrayLLister.maxLightsRC.addControl #colorpicker (("LightTransparency" + vrayLLister.count as string) as name) "" \
				...
				" offset:[625,"+ (-23+ vrayLLister.yOffset) as string + "] width:25")
			...
			vrayLLister.maxLightsRC.addControl #dropDownList (("LightSourceMode" + vrayLLister.count as string) as name) "" filter:on\
				paramStr:(" items:" + vrayLLister.MRSkyPortal_Modes as string + " width:70 offset:[685,"+ (-24+ vrayLLister.yOffset) as string + "]" + \
		...
		if isVRayLight do (
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("TemperatureEn" + vrayLLister.count as string) as name) "" \
				...
				" offset:[233,"+ (-22+ vrayLLister.yOffset) as string + "] width:15 enabled:" + colorEn as string)
			...
			vrayLLister.maxLightsRC.addControl #spinner (("Temperature" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[247,"+ (-21+ vrayLLister.yOffset) as string + "]" + \
			...
			vrayLLister.maxLightsRC.addControl #dropDownList (("PowerUnits" + vrayLLister.count as string) as name) "" filter:on\
				paramStr:(" items:#(\"Default (image)\", \"Luminous power (lm)\", \"Luminance (lm/m?/sr)\", \"Radiant power (W)\", \"Radiance (W/m?/sr)\")" + \
								" width:100 offset:[307,"+ (-24+ vrayLLister.yOffset) as string + "] selection:" + \
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("LightShdOn" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + (vrayLLister.getLightProp vrayLLister.LightIndex[vrayLLister.count][1].baseObject #castShadows as string)+ \
				" offset:[421,"+ (-23+ vrayLLister.yOffset) as string + "] width:15 enabled:" + shadowsEn as string)
			vrayLLister.maxLightsRC.addHandler (("LightShdOn" + vrayLLister.count as string) as name) #'changed state' filter:on \
				codeStr:("vrayLLister.setLightProp vrayLLister.LightIndex[" + vrayLLister.count as string + "][1].baseobject #castShadows state")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("LightShdOn" + vrayLLister.count as string) as name)
			...
			vrayLLister.maxLightsRC.addControl #spinner (("Subdivs" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[451,"+ (-21+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("ShadowBias" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[509,"+ (-21+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("InvisibleOn" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + invisibleTmp as string + " offset:[577,"+ (-20+ vrayLLister.yOffset) as string + "] width:15" + \
			...
			vrayLLister.maxLightsRC.addControl #dropDownList (("SkylightMode" + vrayLLister.count as string) as name) "" filter:on\
				paramStr:(" items:#(\"None\", \"Normal\", \"Simple\") width:60 offset:[609,"+ (-24+ vrayLLister.yOffset) as string + "]" + \
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("AffectDiffOn" + vrayLLister.count as string) as name) "" \
				...
				" offset:[673,"+ (-23+ vrayLLister.yOffset) as string + "] width:15")
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("AffectSpecOn" + vrayLLister.count as string) as name) "" \
				...
				" offset:[701,"+ (-20+ vrayLLister.yOffset) as string + "] width:15")
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("AffectReflectOn" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + affectReflectTmp as string + " offset:[729,"+ (-20+ vrayLLister.yOffset) as string + "] width:15")
		...
		if isVRayIESLight do (
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("TemperatureEn" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + (((vrayLLister.getLightProp vrayLLister.LightIndex[vrayLLister.count][1].baseObject #color_mode) == 1) as string) + \
				" offset:[233,"+ (-22+ vrayLLister.yOffset) as string + "] width:15")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("TemperatureEn" + vrayLLister.count as string) as name)
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("LightShdOn" + vrayLLister.count as string) as name) "" \
				...
				" offset:[321,"+ (-20+ vrayLLister.yOffset) as string + "] width:15")
			vrayLLister.maxLightsRC.addHandler (("LightShdOn" + vrayLLister.count as string) as name) #'changed state' filter:on \
			...
			vrayLLister.maxLightsRC.addControl #spinner (("Subdivs" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[351,"+ (-21+ vrayLLister.yOffset) as string + "] enabled:" + subdivsEn as string)
			vrayLLister.maxLightsRC.addHandler (("Subdivs" + vrayLLister.count as string) as name) #'changed val' filter:on \
			...
			vrayLLister.maxLightsRC.addControl #spinner (("ShadowBias" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[409,"+ (-21+ vrayLLister.yOffset) as string + "]")
			vrayLLister.maxLightsRC.addHandler (("ShadowBias" + vrayLLister.count as string) as name) #'changed val' filter:on \
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("AffectDiffOn" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + (vrayLLister.getLightProp vrayLLister.LightIndex[vrayLLister.count][1].baseObject #affect_diffuse as string) + \
				" offset:[477,"+ (-20+ vrayLLister.yOffset) as string + "] width:15")
			vrayLLister.maxLightsRC.addHandler (("AffectDiffOn" + vrayLLister.count as string) as name) #'changed state' filter:on \
				codeStr:("vrayLLister.setLightProp vrayLLister.LightIndex[" + vrayLLister.count as string + "][1].baseobject #affect_diffuse state")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("AffectDiffOn" + vrayLLister.count as string) as name)
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("AffectSpecOn" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + (vrayLLister.getLightProp vrayLLister.LightIndex[vrayLLister.count][1].baseObject #affect_specular as string) + \
				" offset:[505,"+ (-20+ vrayLLister.yOffset) as string + "] width:15")
			vrayLLister.maxLightsRC.addHandler (("AffectSpecOn" + vrayLLister.count as string) as name) #'changed state' filter:on \
				codeStr:("vrayLLister.setLightProp vrayLLister.LightIndex[" + vrayLLister.count as string + "][1].baseobject #affect_specular state")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("AffectSpecOn" + vrayLLister.count as string) as name)
			...
			vrayLLister.maxLightsRC.addControl #dropDownList (("UseLShape" + vrayLLister.count as string) as name) "" filter:on\
				paramStr:(" items:#(\"No\", \"Shadows only\", \"Illumination and shadows\")" + \
								" width:50 offset:[527,"+ (-24+ vrayLLister.yOffset) as string + "] selection:" + \
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("AreaSpecularsOn" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + areaSpecularsTmp as string + " offset:[599,"+ (-23+ vrayLLister.yOffset) as string + "] width:15")
		...
		if isVRaySun do (
			...
			vrayLLister.maxLightsRC.addControl #checkbox (("InvisibleOn" + vrayLLister.count as string) as name) "" \
				paramStr:("checked:" + (vrayLLister.getLightProp vrayLLister.LightIndex[vrayLLister.count][1].baseObject #invisible as string) + \
								" offset:[387,"+ (-20+ vrayLLister.yOffset) as string + "] width:15")
			vrayLLister.maxLightsRC.addHandler (("InvisibleOn" + vrayLLister.count as string) as name) #'changed state' filter:on \
				codeStr:("vrayLLister.setLightProp vrayLLister.LightIndex[" + vrayLLister.count as string + "][1].baseobject #invisible state")
			append vrayLLister.UIControlList[2][vrayLLister.Count] (("InvisibleOn" + vrayLLister.count as string) as name)
			...
			vrayLLister.maxLightsRC.addControl #spinner (("Turbidity" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[417,"+ (-21+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("Ozone" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[475,"+ (-21+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #spinner (("PhotonEmitRadius" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[533,"+ (-21+ vrayLLister.yOffset) as string + "]")
			...
			vrayLLister.maxLightsRC.addControl #dropDownList (("SkyModel" + vrayLLister.count as string) as name) "" filter:on\
				paramStr:(" items:#(\"Preetham et al.\", \"CIE Clear\", \"CIE Overcast\") width:100 offset:[593,"+ (-24+ vrayLLister.yOffset) as string + "]" + \
			...
			vrayLLister.maxLightsRC.addControl #spinner (("HorizIllumination" + vrayLLister.count as string) as name) "" \
				...
				"fieldwidth:45 align:#left offset:[695,"+ (-24+ vrayLLister.yOffset) as string + "] enabled:" + (vrayLLister.LightIndex[vrayLLister.count][1].sky_model > 0) as string)
	...
	(
		...
		(
			...
			createControls hasMultiplier:true hasColor:true isVRayIESLight:true hasCausticsSubdivs:true hasWireColor:true hasIconText:true
			vrayLLister.count += 1
			vrayLLister.LightInspectorSetup.pbar.value = vrayLLister.count*100/vrayLLister.totalLightCount
		) -- end For i in VRay Lights
	)
	...
	(
		...
		(
			...
			createControls hasMultiplier:true hasColor:true isVRayAmbientLight:true hasCausticsSubdivs:true hasWireColor:true
			vrayLLister.count += 1
			vrayLLister.LightInspectorSetup.pbar.value = vrayLLister.count*100/vrayLLister.totalLightCount
		) -- end For i in VRay Lights
	)
...
on execute do
	...
	if classof DialogSize != Point2 do dialogSize = [940,300]
